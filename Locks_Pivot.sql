Drop Table if exists CARES2SQL.CARES2SQL.Justin_Locks_Piovt_Loop
...
[SMITHLAND LOCK & DAM],[STARVED ROCK LOCK & DAM],[WILLOW ISLAND LOCKS & DAM] into CARES2SQL.CARES2SQL.Justin_Locks_Piovt_Loop
from (select  FacilityID as FacilityID, Analysis, Type, PMSNAME as PMSNAME from CARES2SQL.CARES2SQL.Justin_LoopLocks) as datasource 
